 ...
 *
 */
@Autonomous(name = "Auton Test 8553", group = "Linear Opmode")
//@Disabled
public class Auton_Test_Example8553 extends LinearOpMode {
    ...
    private static final double DISTANCE_BACK_FINAL = 8.0;            //
            ...
            switch ( step )
            {
                ...
                case KNOCK_OFF_JEWEL:
                    ...
                    if ( color == JewelKnocker.COLORS.RED )
                    {
                        ...
                        errorTicks = go.AutonForward( DISTANCE_FOR_JEWEL );
                    ...
                    else
                    {
                        ...
                        errorTicks = go.AutonReverse( DISTANCE_FOR_JEWEL );
                        yDistanceFromStart = -DISTANCE_FOR_JEWEL;
                    }
                ...
                case ROTATE_TO_FACE_BOX:
                    errorTicks = go.AutonRotateCounterclockwise( DEGREES_2_ROTATE );
                ...
                case BACK_UP:
                    errorTicks = go.AutonReverse( DISTANCE_BACK_FINAL );
